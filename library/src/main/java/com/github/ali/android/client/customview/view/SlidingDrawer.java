...
public class SlidingDrawer extends FrameLayout {
    ...
    private enum PanelState {OPEN, CLOSE, OPENING, CLOSING}
...
//                            Log.d(TAG, "onTouchEvent far"+ farMargin);
//                            Log.d(TAG, "onTouchEvent close"+ closeMargin);
//                            Log.d(TAG, "onTouchEvent offset"+ mOffsetDistance);
//                            Log.d(TAG, "onTouchEvent distance"+ distance);

                            if(mSlideState == PanelState.OPEN){
                                notifyActionClosing(Math.abs(closeMargin), distance);
                            } else if(mSlideState == PanelState.CLOSE){
                                notifyActionOpening(Math.abs(closeMargin), distance);
                            }
                        }
                        break;
                    case STICK_TO_TOP:
...
//                Log.d(TAG, "onTouchEvent: ACTION_UP");
                        ...
                        animate()
                                ...
                                .setListener(new AnimatorListenerAdapter() {
                                    ...
                                    public void onAnimationStart(Animator animation) {
                                        ...
                                        Log.d(TAG, " open to close : Anim start");
                                        notifyActionForState(PanelState.CLOSING, true);
                                    }
                                    @Override
                                    public void onAnimationEnd(Animator animation) {
                                        super.onAnimationEnd(animation);
                                    ...
                                    public void onAnimationCancel(Animator animation) {
                                        ...
                                        Log.d(TAG, " open to close : Anim cancel");
                                    }
                                });
                        break;
                    case CLOSE:
                        animate()
                                ...
                                .setListener(new AnimatorListenerAdapter() {
                                    ...
                                    public void onAnimationStart(Animator animation) {
                                        super.onAnimationStart(animation);
                                        Log.d(TAG, " close to open : Anim start");
                                    }
                                    @Override
                                    public void onAnimationEnd(Animator animation) {
                                        super.onAnimationEnd(animation);
                                    ...
                                    public void onAnimationCancel(Animator animation) {
                                        super.onAnimationCancel(animation);
                                        Log.d(TAG, " close to open : Anim cancel");
                                    }
                                });
                        break;
                }
    ...
    private void notifyActionForState(PanelState stateToApply, boolean notify) {
        ...
        if (notify) {
//            if(stateToApply == PanelState.OPENING){
////                notifyActionOpening();
//            } else if(stateToApply == PanelState.CLOSING){
////                notifyActionClosing();
//            } else {
...
//            }
    ...
    private void notifyActionClosing(int offset, int distance){
        if(mOnInteractListener != null){
            mOnInteractListener.closing(offset, distance);
        }
    }

    private void notifyActionOpening(int offset, int distance){
        if(mOnInteractListener != null){
            mOnInteractListener.opening(offset, distance);
        }
    }
    ...
    public interface OnInteractListener {
        ...
        void opening(int offset, int distance);

        void closing(int offset, int distance);
    }
